...
describe Mailboxer::Receipt do
  ...
  # it "should be able to be searched" do
  #   # Mailboxer.search_enabled == true
  #   @mail1
  #   a = Mailboxer::Receipt.search do
  #     fulltext @mail1.message.conversation.participants.first.name
  #   end
  #   a.results.size.should==1
  # end
